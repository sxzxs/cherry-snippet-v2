...
; AHK version:      AHK 2.0-beta.1 (U32/U64)
; Tested on:        Win 10 Pro (x64), SQLite 3.11.1 (x64)
; Version:          0.0.00.00/2021-08-07/just me
;                   0.1.01.00/2022-10-04/just me - Fixed bug in Prepare()
;                                                - Changed DllCall parameter type PtrP to UPtrP
...
Class SQLiteDB {
   ...
   __New() {
      ...
      This._Queries := Map()            ; Valid queries                                 (Map)
      ...
      If (SQLiteDB._RefCount = 0) {
         ...
         If (VerCompare(LibVersion, SQLiteDB._MinVersion) < 0) {
            ...
            MsgBox("Version " . SQLiteDB.Version . " of SQLite3.dll is not supported!`n`n" .
   ...
   ; Parameters:           SQL         - SQL statement to be compiled
   ;                       BlobArray   - Array of Buffer objects containing the binary data
   ; Return values:        On success  - True
   ;                       On failure  - False, ErrorMsg / ErrorCode contain additional information
   ...
   StoreBLOB(SQL, BlobArray) {
      ...
      For BlobNum, Blob In BlobArray {
         If !(Type(Blob) = "Buffer") || !Blob.Size {
            This.ErrorMsg := A_ThisFunc . ": Invalid parameter BlobArray!"
            This.ErrorCode := 0
            Return False
         }
         RC := DllCall("SQlite3.dll\sqlite3_bind_blob", "Ptr", Query, "Int", BlobNum, "Ptr", Blob,
      ...
      If (RC := DllCall("SQlite3.dll\sqlite3_finalize", "Ptr", Query, "Cdecl Int")) {
         This.ErrorMsg := A_ThisFunc . ": " . This._ErrMsg()
         This.ErrorCode := RC
         Return False
      }
   ...
   Class _Statement {
      ...
      Bind(Index, Type, Param3 := "", Param4 := 0, Param5 := 0) {
         ...
         If (Type = "Blob") { ; ----------------------------------------------------------------------------------------
            ; Param3 = Buffer object
            If !(Type(Param3) = "Buffer") {
            ...
            RC := DllCall("SQlite3.dll\sqlite3_bind_blob", "Ptr", This._Handle, "Int", Index, "Ptr", Param3,
                          "Int", Param3.Size, "Ptr", -1, "Cdecl Int")
            If (RC) {
               This.ErrorMsg := This._ErrMsg()
               This.ErrorCode := RC
               Return False
      ...
      Reset(ClearBindings := True) {
         ...
         If (ClearBindings) {
            If (RC := DllCall("SQlite3.dll\sqlite3_clear_bindings", "Ptr", This._Handle, "Cdecl Int")) {
               This.ErrorMsg := This._DB._ErrMsg()
               This.ErrorCode := RC
               Return False
            }
