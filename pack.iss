...
[Files]
Source: "G:\我的AHK程序\我的工程\cherry-snippet\cherry-snippet-v2\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "G:\我的AHK程序\我的工程\cherry-snippet\cherry-snippet-v2\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
