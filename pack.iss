...
[Files]
Source: "E:\我的AHK程序\cherry-snippet-v2\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "E:\我的AHK程序\cherry-snippet-v2\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
